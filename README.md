...
## Description
A new hosted customer support agent that can search a knowledge base, create support tickets, track ticket status, and escalate complex issues to human agents when needed. It responds politely, provides step-by-step troubleshooting, and always confirms resolution before closing a case.
...
- **Playground**: Foundry portal → Agents → real-hosted-agent → Playground
- **API**: `{project_endpoint}/agents/real-hosted-agent/endpoint/protocols/openai/responses`
